function plotSimplePlots(glob, depos)
        ...
        % Plotting parameters to use in the function calls below e.g. calls to plot cross sections
        ...
        xCross = 240; % Position of the dip-oriented section on the x-axis, grid cell dimensions
        yCross = 150;  % Position of the strike-oriented section on the y-axis, grid cell dimensions
        ...
        upperLimitX = 0;
        maxZ = 0;
        kmScale = 1; % Want to plot 3D view in km not meters, so set this to true

        fprintf("Plot 3D view with flow apices positions, xy iteration ...")
        plot3DView(glob, depos, newFigure, lobeOrFlowColourCoding, transparency, kmScale);
        plotFlowApecesXYZ(glob, 0, kmScale)
        fprintf("Done\n")
